...
import com.binar.binarchallenge4.entity.auth.RolePath;
import com.binar.binarchallenge4.repository.auth.AuthUserRepository;
import com.binar.binarchallenge4.repository.auth.ClientRepository;
import com.binar.binarchallenge4.repository.auth.RolePathRepository;
import com.binar.binarchallenge4.repository.auth.RoleRepository;
...
public class DatabaseSeeder implements ApplicationRunner {
    ...
    public void insertUser(String password) {
        for (String userNames: users) {
            ...
            AuthUser oldUser = userRepository.findOneByUsername(username);
            if (null == oldUser) {
                oldUser = new AuthUser();
